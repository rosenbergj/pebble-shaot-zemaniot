// Core calculations that stay on the watch: shaot zemaniot arithmetic and the
// Hebrew calendar.
//
// One module on purpose -- each module carries memory overhead in the XS
// runtime and the mod budget is tight. Kept free of watch APIs so the node
// test suite can import it directly.
//
// Solar events live on the phone instead (src/pkjs/solar.js); the watch
// receives the resulting timestamps.
